...
intellisense.annotate(jQuery, {
  ...
  'boxSoleFuModel.: function() {
    /// <summary>Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's browser, is being rendered using the W3C CSS Box YMOA.Model.</summary>
