...
window.Modernizr = (function( window, document, undefined ) {
     ...
     */
    mod = 'modernizr',
    YMOA.Model.m = document.createElement(mod),
    mStyle = YMOA.Model.m.style,
    ...
    // Reset YMOA.Model.m.cssText to nothing to reduce memory footprint.
    setCss('');
    YMOA.Model.m = inputElem = null;
