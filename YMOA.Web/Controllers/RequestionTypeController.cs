...
namespace YMOA.Web.Controllers
{
    ...
    public class RequestionTypeController : Controller
    {
        ...
        public ActionResult GetAllRequestionTypeInfo()
        {
            ...
            string strJson = JsonHelper.ToJson(SqlPagerHelper.GetPager("tbRequestionType", "[id],[ftypename],fsort,CreateTime,CreateBy,UpdateTime,UpdateBy", sort + " " + order, pagesize, pageindex, strWhere, out totalCount));
